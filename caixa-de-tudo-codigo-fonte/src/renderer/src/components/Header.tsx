  ...
  return (
    <header className="drag-region flex h-14 shrink-0 items-center justify-between border-b border-white/5 px-4">
      <div className="flex items-center gap-3">
        <div className="h-2 w-2 rounded-full bg-gradient-to-br from-accent-violet to-accent-purple shadow-glow" />
      ...
      <div className="no-drag flex items-center gap-1">
        <button
          ...
          className="rounded-md p-1.5 text-gray-400 transition hover:bg-white/5 hover:text-accent-violet"
          title="Configurações"
        >
          <Settings size={16} />
        </button>
